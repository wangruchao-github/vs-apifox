...
export interface JavaParserVisitor<Result> extends ParseTreeVisitor<Result> {
	...
	/**
	 * Visit a parse tree produced by the `SquareBracketExpression`
	 * labeled alternative in `JavaParser.expression`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitSquareBracketExpression?: (ctx: SquareBracketExpressionContext) => Result;

	/**
	 * Visit a parse tree produced by the `MemberReferenceExpression`
	 * labeled alternative in `JavaParser.expression`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitMemberReferenceExpression?: (ctx: MemberReferenceExpressionContext) => Result;
	...
	/**
	 * Visit a parse tree produced by the `MethodReferenceExpression`
	 * labeled alternative in `JavaParser.expression`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitMethodReferenceExpression?: (ctx: MethodReferenceExpressionContext) => Result;

	/**
	 * Visit a parse tree produced by the `ExpressionSwitch`
	 * labeled alternative in `JavaParser.expression`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitExpressionSwitch?: (ctx: ExpressionSwitchContext) => Result;

	/**
	 * Visit a parse tree produced by the `PostIncrementDecrementOperatorExpression`
	 * labeled alternative in `JavaParser.expression`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitPostIncrementDecrementOperatorExpression?: (ctx: PostIncrementDecrementOperatorExpressionContext) => Result;
	...
	/**
	 * Visit a parse tree produced by the `InstanceOfOperatorExpression`
	 * labeled alternative in `JavaParser.expression`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitInstanceOfOperatorExpression?: (ctx: InstanceOfOperatorExpressionContext) => Result;
